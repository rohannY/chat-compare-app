...
const Hero = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative overflow-hidden pt-20 bg-gradient-to-b from-slate-50 via-blue-50/30 to-white rounded-t-2xl"
    >
      <motion.div className="absolute inset-0 opacity-6 0">
        <motion.div
          style={{ x: x1, y: y1 }}
          className="absolute -top-40 -left-40 w-80 h-80 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl"
        />
        <motion.div
          style={{ x: x2, y: useTransform(scrollYProgress, [0, 1], [0, 150]) }}
          className="absolute top-10 right-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl"
        />
        <motion.div
          style={{
            x: -x2,
          ...
          className="absolute -bottom-8 left-40 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl"
        />
        <motion.div
          style={{ x: x1, y: useTransform(scrollYProgress, [0, 1], [0, 120]) }}
          className="absolute right-20 bottom-20 w-56 h-56 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl animate-blob"
        />
      </motion.div>
            ...
            >
              ...
              >
                <motion.span
                  ...
                  animate={
                    isHovering ? { scale: [1, 1.5], opacity: [0, 1] } : {}
                  }
